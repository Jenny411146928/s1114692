...
fun FirstScreen(navController: NavController) {
    ...
    {
        Text(text = if (currentImage == R.drawable.service)"瑪利亞基金會服務總覽" else "關於App作者", style = TextStyle(color = Color.Blue))
        ...
        Button(onClick = {
            ...
            Text(text = if (currentImage == R.drawable.service) "作者：資管系李盈蓁" else "服務總覽")
        }
    }
}
...
fun Main() {
    ...
    Column {
        TopAppBar(
            title = { Text(text = "")
            Image(
                painter = painterResource(id = R.drawable.maria), contentDescription = null, modifier = Modifier
                    .height(50.dp),
            )
